...
import com.tracer.app.web.rest.errors.EmailAlreadyUsedException;
import com.tracer.app.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
...
public class UserResource {
    ...
    @GetMapping("/admin/users-information/{login}")
    public ResponseEntity<User> getUserInformationByLogin(
    ...
    @GetMapping("/admin/all/users-information")
    public ResponseEntity<List<User>> getAllUserInformation(Pageable pageable) {
        log.debug("REST request to get all user information");
        Page<User> page = userService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }

    @GetMapping("/user/users-information/")
    public ResponseEntity<User> getUserInformationByCurrentLogin() {
        User user = userService.getUserLogin();
        log.debug("REST request to get User : {}", user.getLogin());
        return ResponseUtil.wrapOrNotFound(userService.getUserWithAuthoritiesByLogin(user.getLogin()));
    }
